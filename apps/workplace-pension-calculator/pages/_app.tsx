...
function CustomApp({ Component, pageProps }: AppProps) {
  ...
  const canonicalUrl = `https://www.moneyhelper.org.uk/${lang}/pensions-and-retirement/auto-enrolment/workplace-pension-calculator`;
  const isGtmEnabled = process.env.NEXT_PUBLIC_ENVIRONMENT === 'production';

  return (
    <BasePageLayout>
      <Head>
        <title>Workplace pension contribution calculator</title>
