...
A guidance tool that helps users identify their pension type and get relevant next-step information.

## Description

This application asks users a short set of questions and provides tailored pension-type guidance and follow-up actions.
...
npm run serve pension-type-tool

# Or using nx directly
npx nx serve pension-type-tool
```
...
npx nx build pension-type-tool
```
...
- Guided pension type questionnaire
