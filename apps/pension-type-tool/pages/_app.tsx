...
function CustomApp({ Component, pageProps }: AppProps) {
  ...
  const canonicalUrl = `https://www.moneyhelper.org.uk/${lang}/pensions-and-retirement/pension-wise/what-type-of-pension-do-you-have`;
  const isGtmEnabled = process.env.NEXT_PUBLIC_ENVIRONMENT === 'production';

  return (
    <BasePageLayout>
      <Head>
        <title>What type of pension do you have?</title>
