...
import { EligibilityAgeExceptions } from '.';
...
describe('EligibilityAgeExceptions Component', () => {
  beforeEach(() => {
  ...
  it('renders component correctly', () => {
    const { container } = render(
      <EligibilityAgeExceptions step={mockSteps[0]} />,
    );
  ...
  it('renders component with errors', () => {
    ...
    const { container } = render(
      <EligibilityAgeExceptions errors={mockErrors} step={mockSteps[0]} />,
    );
    expect(container).toMatchSnapshot();
  });
});
