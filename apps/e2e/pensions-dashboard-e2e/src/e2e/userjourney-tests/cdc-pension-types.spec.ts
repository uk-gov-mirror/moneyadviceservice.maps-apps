...
test.describe('Collective Defined Contribution Pensions', () => {
  ...
  test('User Journey for: Collective Defined Contribution Pensions in all channels @e2e', async ({
    commonHelpers,
    pendingPensionsPage,
