export const config = {
  locales: [
    {
      ...
      text: {
        ...
        off: 'I ffwrdd',
        notifyTitle:
          '<h2>Cwcis ar Gyfeirlyfr Yswiriant Teithio Gwasanaeth Arian a Phensiynau</h2>',
        notifyDescription:
        ...
        intro:
          "<p>Mae cwcis yn ffeiliau a arbedir ar eich ffôn, llechen neu gyfrifiadur pan ymwelwch â gwefan.</p><p>Rydym yn defnyddio cwcis i storio gwybodaeth am sut rydych chi'n defnyddio Gyfeirlyfr Yswiriant Teithio, megis y tudalennau rydych chi'n ymweld â nhw.</p><p>I gael mwy o wybodaeth, ymwelwch â'n <a href='https://www.moneyhelper.org.uk/cy/about-us/cookie-policy' target='_blank'>Polisi Cwcis</a> a'n <a href='https://www.moneyhelper.org.uk/cy/about-us/privacy-notice' target='_blank'>Polisi Preifatrwydd</a>.</p>",
        necessaryTitle: '<h2>Cwcis sydd eu hangen</h2>',
        necessaryDescription:
          "<p>Mae rhai cwcis yn hanfodol er mwyn i'r wefan weithredu'n gywir, megis y rhai sy'n cofio eich sesiwn pan fyddwch chi'n cofrestru neu'n diweddaru manylion eich cwmni.</p>",
      },
      optionalCookies: [
        {
          name: 'analytics',
  ...
  text: {
    ...
    notifyTitle:
      '<h2>Cookies on Money and Pensions Service Travel Insurance Directory</h2>',
    notifyDescription:
    ...
    intro:
      '<p>Cookies are files saved on your phone, tablet or computer when you visit a website.</p><p>We use cookies to store information about how you use the Travel Insurance Directory, such as the pages you visit.</p><p>For more information visit our <a href="https://www.moneyhelper.org.uk/en/about-us/cookie-policy" target="_blank">Cookie Policy</a> and <a href="https://www.moneyhelper.org.uk/en/about-us/privacy-notice" target="_blank">Privacy Policy</a>.</p>',
    necessaryTitle: '<h2>Necessary Cookies</h2>',
    necessaryDescription:
      '<p>Some cookies are essential for the site to function correctly, such as those remembering your session when you register or update your firm details.</p>',
  },
};
