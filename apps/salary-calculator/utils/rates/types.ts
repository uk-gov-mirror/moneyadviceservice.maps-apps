...
interface BasicTaxRates {
  ...
  STUDENT_LOAN_PLAN_1_YEARLY_THRESHOLD: number;
  STUDENT_LOAN_PLAN_2_YEARLY_THRESHOLD: number;
  STUDENT_LOAN_PLAN_4_YEARLY_THRESHOLD: number;
  STUDENT_LOAN_PLAN_5_YEARLY_THRESHOLD: number;
  STUDENT_LOAN_POSTGRAD_YEARLY_THRESHOLD: number;
  ...
  NI_ANNUAL_MIDDLE_BRACKET: number;
  NI_ANNUAL_UPPER_BRACKET: number;
  ...
  // See https://www.gov.uk/government/publications/rates-and-allowances-income-tax/income-tax-rates-and-allowances-current-and-past#other-allowances
