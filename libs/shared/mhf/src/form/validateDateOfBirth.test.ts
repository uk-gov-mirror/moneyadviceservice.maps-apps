...
describe('validateDateOfBirth', () => {
  ...
  test.each`
    ...
    ${'missing fields'}           | ${''}    | ${''}    | ${''}                           | ${'date-of-birth'}
    ${'non-numeric values'}       | ${'abc'} | ${'xyz'} | ${'1990'}                       | ${'date-of-birth'}
    ${'out-of-range day'}         | ${'32'}  | ${'3'}   | ${'1990'}                       | ${'date-of-birth'}
    ${'out-of-range month'}       | ${'15'}  | ${'13'}  | ${'1990'}                       | ${'date-of-birth'}
    ${'out-of-range year'}        | ${'15'}  | ${'3'}   | ${'1800'}                       | ${'date-of-birth'}
    ${'future date'}              | ${'1'}   | ${'1'}   | ${new Date().getFullYear() + 1} | ${'date-of-birth'}
    ${'non-leap year Feb 29'}     | ${'29'}  | ${'2'}   | ${'2019'}                       | ${'date-of-birth'}
    ${'leap year Feb 29 (valid)'} | ${'29'}  | ${'2'}   | ${'2020'}                       | ${undefined}
    ${'April 31 (invalid)'}       | ${'31'}  | ${'4'}   | ${'2000'}                       | ${'date-of-birth'}
    ${'Feb 30 (invalid)'}         | ${'30'}  | ${'2'}   | ${'2000'}                       | ${'date-of-birth'}
